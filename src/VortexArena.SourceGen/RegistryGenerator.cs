// =====================================================================================================
// RegistryGenerator — Roslyn incremental source generator for the VortexArena (Godot/C#) port of Xonotic.
//
...
// ([Weapon]/[Item]/[Mutator]/[GameType]/[Monster] from VortexArena.Common.Framework,
// [Turret]/[Vehicle] from VortexArena.Common.Gameplay) are enrolled into their
// Registry<T> catalog at COMPILE TIME — no runtime reflection (cf. GameRegistries.Bootstrap).
//
// What it emits, into the *consuming* assembly (VortexArena.Common, where all registrable content lives):
//
...
//             {
//                 VortexArena.Common.Framework.Registry<VortexArena.Common.Gameplay.Weapon>.Register(new global::SomeNs.Blaster());
//                 ...
//                 VortexArena.Common.Framework.Registry<VortexArena.Common.Gameplay.Weapon>.Sort();
//                 ...
//             }
//         }
//     }
...
//   The generator ships in the netstandard2.0 analyzer project VortexArena.SourceGen, wired into
//   src/VortexArena.Common/VortexArena.Common.csproj (the assembly holding every attributed type) as:
//       <ProjectReference Include="..\VortexArena.SourceGen\VortexArena.SourceGen.csproj"
...
//     project-reference VortexArena.Common. Marker attributes are matched BY NAME via the semantic model.
...
namespace VortexArena.SourceGen
{
    ...
    public sealed class RegistryGenerator : IIncrementalGenerator
    {
        ...
        private static SourceText BuildSource(List<RegisteredType> types)
        {
            ...
            sb.AppendLine("// Generated by VortexArena.SourceGen.RegistryGenerator (ADR-0003). Do not edit.");
