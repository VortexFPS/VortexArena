...
public sealed partial class NetGame : Node3D
{
    ...
    public override void _Process(double delta)
    {
        ...
        if (_client.Accepted)
        {
            ...
            // Three independent "this host is not a player" gates, all of which must hold off the auto-join:
            ...
            // --observe and cl_bench_spectate: the host is a fixed/benchmark CAMERA, which must stay observing.
