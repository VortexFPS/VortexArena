...
public partial class Shell : Node
{
    ...
    /// <summary>
    /// [T63] Boot a DEMO REPLAY: a <see cref="VortexArena.Server.GameWorld.ReplayMode"/> listen server playing back
    ...
    public async void StartReplay(string demoPath)
    {
        ...
        if (!net.ConfigureReplay(VortexArena.Game.Net.NetGame.ResolveDemoPath(demoPath),
