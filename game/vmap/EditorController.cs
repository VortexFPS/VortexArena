...
public sealed partial class EditorController : Node3D
{
    ...
    public static void RegisterDefaults(CvarService c)
    {
        ...
        c.Register(EditorLighting.CvarAmbient, "0.03", CvarFlags.Save);
        ...
        c.Register(EditorLighting.CvarBakeScale, "0.01", CvarFlags.Save);
        ...
        c.Register(EditorLighting.CvarBakeGamma, "1.3", CvarFlags.Save);
