...
As of the last run: **2967 distinct cvars**. The count is high because the weapon /
...
| `bot_` | Bot management & AI tuning | Server | 53 | `bot_number`, `bot_ai_thinkinterval` |
...
## Full inventory
_Generated by `python tools/find-cvars.py` - 3003 distinct cvars._
...
- `g_nades_throw_dir`  _( unregistered )_
- `g_nades_throw_dir_offhand`  _( unregistered )_
...
- `r_fakeshadows`
- `r_fakeshadows_darken`
- `r_fakeshadows_size`
- `r_fakeshadows_throwdistance`
- `r_gi`
- `r_gi_bounces`
- `r_gi_cascades`
- `r_gi_energy`
...
- `r_map_tint`
- `r_map_tint_strength`
- `r_missingtextures`  _( unregistered )_
- `r_model_dlight`
- `r_model_dlight_scale`
- `r_model_light_gamma`
- `r_model_light_scale`
- `r_model_lightgrid`
...
- `r_occlusion_cull`
- `r_pvs_cull`
- `r_pvs_cull_dynlights`
- `r_pvs_cull_emitters`
- `r_pvs_cull_entities`
- `r_pvs_cull_entities_margin`
- `r_restart`  _( unregistered )_
- `r_scene_tint`
- `r_scene_tint_strength`
- `r_shadow_dlight_max`
- `r_shadow_dlight_shadow_budget`
...
- `r_texture_dds_load`
- `r_texture_dds_save`
- `r_texturecompression_cpubudget`
- `r_texturecompression_offthread`
- `r_viewfbo`  _( unregistered )_
- `r_volumetricfog`
- `r_volumetricfog_density`
- `r_volumetricfog_shafts`
- `r_vram_census`  _( unregistered )_
- `r_warpzone`
...
- `menu_scroll_averaging_time`
- `menu_scroll_averaging_time_pressed`
...
- `menu_slist_categories_onlyifmultiple`  _( unregistered )_
- `menu_slist_maxping`  _( unregistered )_
- `menu_slist_modfilter`  _( unregistered )_
- `menu_slist_modimpurity`  _( unregistered )_
- `menu_slist_recommendations`  _( unregistered )_
- `menu_slist_recommendations_maxping`  _( unregistered )_
- `menu_slist_recommendations_minfreeslots`  _( unregistered )_
- `menu_slist_recommendations_minhumans`  _( unregistered )_
- `menu_slist_recommendations_purethreshold`  _( unregistered )_
...
- `sys_ticrate`  _( cross-boundary )_
...
- `gl_texturecompression_2d`  _( unregistered )_
- `gl_texturecompression_color`  _( unregistered )_
- `gl_texturecompression_gloss`  _( unregistered )_
- `gl_texturecompression_glow`  _( unregistered )_
- `gl_texturecompression_lightcubemaps`  _( unregistered )_
- `gl_texturecompression_normal`  _( unregistered )_
- `gl_texturecompression_q3bspdeluxemaps`  _( unregistered )_
- `gl_texturecompression_q3bsplightmaps`  _( unregistered )_
- `gl_texturecompression_reflectmask`  _( unregistered )_
- `gl_texturecompression_sky`  _( unregistered )_
- `gl_texturecompression_sprites`  _( unregistered )_
...
- `conductor_control`
- `conductor_control_key`
- `condump_stripcolors`  _( unregistered )_
...
- `map_minplayers`
- `mapname`  _( unregistered, cross-boundary )_
- `mastervolume`
...
- `sv_master_catalog`
- `sv_master_catalog_refresh`
- `sv_master_catalog_url`
- `sv_master_url`
...
- `cl_decals_time`  _( unregistered )_
