...
public class ScoreboardColumnsTests
{
    ...
    public void ScoreboardBlock_ItemStatsTally_RoundTrips()
    {
        ...
        var rows = ScoreboardBlock.CaptureRows(new (int, XonoticGodot.Common.Framework.Entity)[] { (3, p) });
    ...
    public void ScoreboardBlock_EmptyItemStats_RoundTripsEmpty()
    {
        ...
        var rows = ScoreboardBlock.CaptureRows(new (int, XonoticGodot.Common.Framework.Entity)[] { (1, p) });
