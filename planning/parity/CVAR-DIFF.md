...
- exec'd by port only: `vortex-bal-wep.cfg`
- exec'd by port only: `vortex-balance.cfg`
- exec'd by port only: `vortex-client.cfg`
- exec'd by port only: `vortex-common.cfg`
- exec'd by port only: `vortex-physics.cfg`
...
| `cl_deathglow` | `2` | `0` | game/client/ModelTint.cs:218 | fallback |
| `r_hdr_glowintensity` | `1` | `0` | game/client/ModelTint.cs:234 | fallback |
...
- `g_` ×954: `g_as_respawn_delay_large`, `g_as_respawn_delay_large_count`, `g_as_respawn_delay_max`, `g_as_respawn_delay_small`, `g_as_respawn_delay_small_count`, `g_as_respawn_waves`, `g_as_weapon_stay`, `g_assault` …
- `cl_` ×101: `cl_accuracy_data_receive`, `cl_accuracy_data_share`, `cl_arcbeam_simple`, `cl_areagrid_link_SOLID_NOT`, `cl_autodemo_delete_keepmatches`, `cl_autodemo_delete_keeprecords`, `cl_autodemo_nameformat`, `cl_bobmodel_side` …
