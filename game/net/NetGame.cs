...
public sealed partial class NetGame : Node3D
{
    ...
    private void AttachWorldRender(CollisionWorld? sharedEffectsWorld = null)
    {
        ...
        // broadphase, no server-tick gate; see ClientWorld.SetClientCollision). Safe to share this instance:
        // ragdolls solve on the main thread, like the prediction/effect traces above — unlike the SDF lane
        // below, which runs on a background Task and therefore needs its own world.
        _render.SetClientCollision(effectsWorld);
